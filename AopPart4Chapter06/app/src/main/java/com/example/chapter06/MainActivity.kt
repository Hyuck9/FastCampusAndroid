...
import com.example.chapter06.data.Repository
import com.example.chapter06.data.models.airquality.Grade
import com.example.chapter06.data.models.airquality.MeasuredValue
import com.example.chapter06.data.models.monitoringstation.MonitoringStation
...
class MainActivity : AppCompatActivity() {
    ...
    fun displayAirQualityData(monitoringStation: MonitoringStation, measuredValue: MeasuredValue) {
        ...
        (measuredValue.khaiGrade ?: Grade.UNKNOWN).let { grade ->
            binding.contentsLayout.setBackgroundResource(grade.colorResId)
