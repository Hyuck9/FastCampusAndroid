...
import com.example.aop.part5.chapter_05.databinding.ItemStationBinding
import com.example.aop.part5.chapter_05.domain.Station
import com.example.aop.part5.chapter_05.extension.dip
import com.example.aop.part5.chapter_05.presentation.view.Badge
...
class StationsAdapter : RecyclerView.Adapter<StationsAdapter.ViewHolder>() {
	...
	inner class ViewHolder(private val binding: ItemStationBinding) : RecyclerView.ViewHolder(binding.root) {
		...
		fun bind(station: Station) {
			...
			binding.favorite.isChecked = station.isFavored
		}
	}
}
